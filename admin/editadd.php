			...
			<div class="row">
				<div class="col-md-5 col-md-offset-1">
					<div class="form-group">
						<form class="form" action="addsedit.php" method="post" style="margin-top:100px;" enctype="multipart/form-data">
                            <?php
							echo '<input type="text" class="form-control" name="title" value='.$data->Title.' required=" "/>
                            <br/>
                            <input type="file" class="form-control" value='.$data->Image.' name="fileToUpload" />
                            <br/>
                            <input type="text" value='.$data->link.' class="form-control" name="link"/>
                            <br/><input type="text" name="id" value='.$id.' hidden/>
                              <input type="text" value='.$data->Image.' name="pic"  hidden/>
                            '; ?>
							<button class="btn btn-primary" name="submit">Add</button>
						</form><br/>
					<?php	echo '<a href="deleteadds.php?id='.$id.'" class="btn btn-danger">'.'Delete'.'</a>'; ?>
					</div>
				</div>
