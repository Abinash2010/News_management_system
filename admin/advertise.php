			...
			<div class="row">
				<div class="col-md-5 col-md-offset-1">
					<div class="form-group">
						<form class="form" action="addadds.php" method="post" style="margin-top:100px;" enctype="multipart/form-data">
							<input type="text" class="form-control" placeholder="Title" name="title" required=" "/>
                            <br/>
                            <input type="file" class="form-control" name="fileToUpload" />
                            <br/>
                            <input type="text" placeholder="website link" class="form-control" name="link"/>
                            <br/>
				...
				<div class="col-md-5">
					<div class="jumbotron" style="height: 100vh;">
						...
						<?php
							$db=getDB();
							$stmt=$db->query("SELECT * FROM `addvertise` order by a_id DESC");
							$stmt->execute();
							$data=$stmt->fetchAll(PDO::FETCH_ASSOC);
							foreach($data as $row)
							{

						echo '<div class="col-sm-offset-1 col-sm-8"><li  ><h5><a href="editadd.php?id='.$row['a_id'].'" style="color:black;">'.$row['Title'].'</a></h5></li></div>';
					}
					?>
				</div>
						</ul>
