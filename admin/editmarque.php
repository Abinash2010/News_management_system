      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<?php
        			...
        			$stmt=$db->prepare("SELECT * FROM `marque` where marque_id=:id");
			...
			<div class="row">
				<div class="col-md-5 col-md-offset-1">
					<div class="form-group">
						<form class="form" action="marqueedit.php" method="post" style="margin-top:100px;">
							<b><h3>News:</h3></b>
						<?php	echo '<textarea class="form-control" placeholder="News" name="marque" style="height: 200px;">'.$data->marque.'</textarea><br/>'; ?>
					<?php	echo '<input type="text" value='.$data->marque_id.' name="id" hidden>'; ?>
							<button class="btn btn-primary">Add</button>
						</form><br/>
					<?php	echo '<a href="deletemarque.php?id='.$id.'" class="btn btn-danger">'.'Delete'.'</a>'; ?>
					</div>
				</div>
