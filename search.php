			...
			<div class="main-grids">
				...
				<div class="recommended">
					<div class="recommended-grids">
						...
						<?php
							$stmt=$db->query("SELECT *  From `news` where Title  like '%".$get."%'");
					...
					<div class="col-md-3 resent-grid recommended-grid slider-top-grids">
						<div class="resent-grid-img recommended-grid-img">
                                ...
                                echo '<h5><a href="single.php?id='.$row['news_id'].'" class="title">'.$row['Title'].'</a></h5>';
                         
                                    ?>
								</div>
								<div class="embed-responsive embed-responsive-16by9">
										<?php
									$video1=embed_converter($row['link']);

							echo '<iframe class="embed-responsive-item"  src="//www.youtube.com/embed/'.$video1.'?rel=0"></iframe>';
							?>
							</div>
						</div>
						<div class="resent-grid-info recommended-grid-info">
                                ...
                                echo '<h3><a href="single.php?id='.$row['news_id'].'" class="title">'.$row['Description'].'</a></h3>';
					...
					<?php
                      ...
                      {
                      	echo '<h3>'.'Your Searched is not present'.'</h3>';
                      }
